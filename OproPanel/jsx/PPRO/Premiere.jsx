...
$._PPP_ = {
    ...
    keepPanelLoaded: function() {
        app.setExtensionPersistent("com.s.OProPanel", 0); // 0, while testing (to enable rapid reload); 1 for "Never unload me, even when not visible."
    },
    ...
    createSubSequence: function() {
        ...
        */
        ...
        if (activeSequence) {
            ...
            for (
                var a = 0; a < activeSequence.videoTracks.numTracks && targetTrackFound === false; a++
            ) {
        ...
        if (sequence) {
            ...
            for (var groupIndex = 0; groupIndex < 2; groupIndex++) {
                ...
                if (group) {
                    for (var trackIndex = 0; trackIndex < group.numTracks; trackIndex++) {
                        for (
                            var clipIndex = 0; clipIndex < group[trackIndex].clips.numItems; clipIndex++
                        ) {
    ...
    changeSequenceColorSpace: function() {
        ...
        if (seq) {
            ...
            if (currentSeqSettings) {
                ...
                for (
                    var trackIndex = 0; trackIndex < seq.videoTracks.numTracks; trackIndex++
                ) {
